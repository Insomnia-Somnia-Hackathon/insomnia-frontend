...
export const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-gray-600 to-black dark:from-gray-800 dark:to-black border-t border-gray-700 py-12">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Medium</a></li>
            </ul>
          </div>
        </div>
