...
export const metadata: Metadata = {
  ...
  description:
    "Maximize your airdrop points across the Somnia ecosystem with automated smart vaults. Deposit once, earn everywhere.",
  ...
  openGraph: {
    ...
    description:
      "Maximize your airdrop points across the Somnia ecosystem with automated smart vaults.",
